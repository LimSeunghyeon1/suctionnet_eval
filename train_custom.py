...
parser.add_argument('--log_dir', default='/DATA2/Benchmark/suction/models/log_kinectV6',
                    help='Dump dir to save model checkpoint [default: log]')
parser.add_argument('--data_root', default='/DATA2/Benchmark/graspnet',
                    help='Dump dir to save model checkpoint [default: log]')
parser.add_argument('--label_root', default='/ssd1/hanwen/grasping/graspnet_label',
                    help='Dump dir to save model checkpoint [default: log]')
...
parser.add_argument('--lr_decay_steps', default='20,40,60',
...
# TODO
print("Flags",FLAGS.model)
model_map = {
    'deeplabv3_resnet50': network.deeplabv3_resnet50(num_classes=FLAGS.num_classes, output_stride=FLAGS.output_stride, pretrained_backbone=False),
    'deeplabv3plus_resnet50': network.deeplabv3plus_resnet50(num_classes=FLAGS.num_classes, output_stride=FLAGS.output_stride, pretrained_backbone=False),
    'deeplabv3_resnet101': network.deeplabv3_resnet101(num_classes=FLAGS.num_classes, output_stride=FLAGS.output_stride, pretrained_backbone=False),
    'deeplabv3plus_resnet101': network.deeplabv3plus_resnet101(num_classes=FLAGS.num_classes, output_stride=FLAGS.output_stride, pretrained_backbone=False),
...
# net = model_map[FLAGS.model](num_classes=FLAGS.num_classes, output_stride=FLAGS.output_stride, pretrained_backbone=False)
net = model_map[FLAGS.model]
...
if FLAGS.finetune:
    if 'deeplabv3' in FLAGS.model:
        ...
        optimizer = optim.Adam([
            ...
            {'params': net.module.classifier.parameters(), 'lr': BASE_LEARNING_RATE}], lr=BASE_LEARNING_RATE,
