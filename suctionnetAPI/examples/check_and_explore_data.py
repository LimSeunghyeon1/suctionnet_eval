...
if __name__ == "__main__":
    ...
    camera = 'realsense'
    label_root = '/home/tidy/PycharmProjects/graspnet/labels'
    suctionnet = SuctionNet(root=dataset_root, label = label_root, camera=camera)
    ...
    print("colli labels", colli_labels)
    # get images
